...
theorem topological_contradiction
    ...
    False := by
  -- Phase 1: Set up topological instances
  ...
  haveI : CompactSpace (AsymptoticSpectrum p₂) :=
    isCompact_univ_iff.mp (AsymptoticSpectrum.isCompact p₂)
  haveI : T2Space (AsymptoticSpectrum p₂) := AsymptoticSpectrum.t2Space p₂
  -- Phase 2: Define pullback map and show its image is closed
  ...
  -- Phase 6: Approximate 2g - 1 by element of A
  ...
  have hh_φ₀ : h φ₀ = -1 := by
    ...
    simp [hg0 (Set.mem_singleton φ₀)]; rfl
  ...
  -- Phase 7: Algebraic contradiction
